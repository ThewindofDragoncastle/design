...
import com.dragon.patternframework.function.adapter.RemoveAdapter
 ...
 */
class InfoRevise : Fragment() , RemoveSup, ImageUploadInterface {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        remove_recyclerview.adapter = RemoveAdapter(false,context,commodities,this)
