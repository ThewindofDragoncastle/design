...
class ToTopAdapter(val isRemove:Boolean, var context: Context, private val commodities: List<Commodity>, val im:ImageUploadInterface) : RecyclerView.Adapter<ToTopAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder?, position: Int) {
        holder?.run {
            ...
            sure.setOnClickListener {
               Toast.makeText(context,"已提交至管理员，请等待审核。",Toast.LENGTH_SHORT).show()
            }
