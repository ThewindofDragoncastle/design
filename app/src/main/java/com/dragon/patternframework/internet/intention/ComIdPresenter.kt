...
import com.dragon.patternframework.internet.CommodityUpload.comIdIntention
import com.dragon.patternframework.javaBean.IntentionData
import com.google.gson.Gson
import java.util.*

class ComIdPresenter : comIdIntention {
    ...
    companion object {
        private val ourInstance = ComIdPresenter()
        fun getInstance(): ComIdPresenter{
            return ourInstance
        }
    }
}